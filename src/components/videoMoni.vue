    ...
    <div class="monitorVideoNav">
          <el-row class="monitorVideoNav-col">
            ...
            <el-col :span="3" class="monitorVideoNav-col">
                <div id="mn">
                      <ul>
                          <li class="monitorVideoNav-li"><img class="r-img" src="../../assets/photo/headerNav/camera1@2x.png" @click="change(1)"/></li>    
                          <li class="monitorVideoNav-li"><img class="r-img" src="../../assets/photo/headerNav/camera4@2x.png" @click="change(4)"/></li>    
                          <li class="monitorVideoNav-li"><img class="r-img" src="../../assets/photo/headerNav/camera9@2x.png" @click="change(9)"/></li>    
                          <li class="monitorVideoNav-li"><img class="r-img" src="../../assets/photo/headerNav/camera16@2x.png" @click="change(16)"/></li>    
                      </ul>     
                </div>
            </el-col>
